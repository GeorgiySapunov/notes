...
### Installation
    ...
    pacman -S --noconfirm bluez bluez-utils bluez-runit cups cups-runit git reflector alsa-utils pulseaudio pulsemixer pulseaudio-alsa pamixer wget curl openssh openssh-runit cronie cronie-runit
